...
libraryByName=I(container, {type: "frame", fill: "$lib:<LibraryKey>:M3:Schemes/Primary", width: "$lib:<LibraryKey>:Spacing:md"})
libraryByGuid=I(container, {type: "frame", fill: "$lib:<LibraryKey>:<setId>:<variableId>"})
```

`$lib:<LibraryKey>:…` is a variable-binding syntax sample. Use keys returned by `fetch_variables({ enabledLibraryKey })`.
...
U("frameId", {variableModes: [{variableSetId: "412:2", modeId: "35:1", libraryKey: "<LibraryKey>"}]})
