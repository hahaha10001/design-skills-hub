...
> ⛔ **HARD RULE — Export EXCLUSIVELY to PNG Image After Generation.** After generation, export the poster to PNG format. Make sure do the export step after all generation steps are completed.
